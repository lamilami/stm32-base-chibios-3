...
*****************************************************************************
** Подключение TFT LCD 320x240 на контроллере ILI9341 SPI mode c µGFX      **
*****************************************************************************
Настройки по умолчанию для платы:
 Everything input with pull-up except:
 PB12 - Push pull output  (SPI2 NSS), initially high state -- "CS"
 PB13 - Alternate output  (SPI2 SCK) -- "SCK"
 PB14 - Normal input      (SPI2 MISO) -- "SDO"
 PB15 - Alternate output  (SPI2 MOSI) -- "SDI"
 PB11 - Push pull output -- подключить к "D/C"
 PB10 - Push pull output -- подключить к "RES"
