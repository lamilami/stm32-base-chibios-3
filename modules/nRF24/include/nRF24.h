 ...
 */
uint8_t nRF24_read_rx_fifo_payload_width(void);
 ...
 * to nRF24_get_clear_irq_flags with the exception that it does <I><B>NOT</B></I> clear
 * the irq_flags.
 *
 * @return Interrupt_flags
 * @retval 0x10 Max Retransmit interrupt
