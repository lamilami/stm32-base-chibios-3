...
void sd_lld_init(void) {
  ...
  INTC.PSR[SPC5_LINFLEX4_RXI_NUMBER].R = SPC5_SERIAL_LINFLEX4_PRIORITY;
  INTC.PSR[SPC5_LINFLEX4_TXI_NUMBER].R = SPC5_SERIAL_LINFLEX4_PRIORITY;
  INTC.PSR[SPC5_LINFLEX4_ERR_NUMBER].R = SPC5_SERIAL_LINFLEX4_PRIORITY;
#endif

#if SPC5_SERIAL_USE_LINFLEX5
  sdObjectInit(&SD6, NULL, notify6);
  SD6.linflexp = &SPC5_LINFLEX5;
  INTC.PSR[SPC5_LINFLEX5_RXI_NUMBER].R = SPC5_SERIAL_LINFLEX5_PRIORITY;
  INTC.PSR[SPC5_LINFLEX5_TXI_NUMBER].R = SPC5_SERIAL_LINFLEX5_PRIORITY;
  INTC.PSR[SPC5_LINFLEX5_ERR_NUMBER].R = SPC5_SERIAL_LINFLEX5_PRIORITY;
#endif

#if SPC5_SERIAL_USE_LINFLEX6
  sdObjectInit(&SD7, NULL, notify7);
  SD7.linflexp = &SPC5_LINFLEX6;
  INTC.PSR[SPC5_LINFLEX6_RXI_NUMBER].R = SPC5_SERIAL_LINFLEX6_PRIORITY;
  INTC.PSR[SPC5_LINFLEX6_TXI_NUMBER].R = SPC5_SERIAL_LINFLEX6_PRIORITY;
  INTC.PSR[SPC5_LINFLEX6_ERR_NUMBER].R = SPC5_SERIAL_LINFLEX6_PRIORITY;
#endif

#if SPC5_SERIAL_USE_LINFLEX7
  sdObjectInit(&SD8, NULL, notify8);
  SD8.linflexp = &SPC5_LINFLEX7;
  INTC.PSR[SPC5_LINFLEX7_RXI_NUMBER].R = SPC5_SERIAL_LINFLEX7_PRIORITY;
  INTC.PSR[SPC5_LINFLEX7_TXI_NUMBER].R = SPC5_SERIAL_LINFLEX7_PRIORITY;
  INTC.PSR[SPC5_LINFLEX7_ERR_NUMBER].R = SPC5_SERIAL_LINFLEX7_PRIORITY;
#endif

#if SPC5_SERIAL_USE_LINFLEX8
  sdObjectInit(&SD9, NULL, notify9);
  SD9.linflexp = &SPC5_LINFLEX8;
  INTC.PSR[SPC5_LINFLEX8_RXI_NUMBER].R = SPC5_SERIAL_LINFLEX8_PRIORITY;
  INTC.PSR[SPC5_LINFLEX8_TXI_NUMBER].R = SPC5_SERIAL_LINFLEX8_PRIORITY;
  INTC.PSR[SPC5_LINFLEX8_ERR_NUMBER].R = SPC5_SERIAL_LINFLEX8_PRIORITY;
#endif

#if SPC5_SERIAL_USE_LINFLEX9
  sdObjectInit(&SD10, NULL, notify10);
  SD10.linflexp = &SPC5_LINFLEX9;
  INTC.PSR[SPC5_LINFLEX9_RXI_NUMBER].R = SPC5_SERIAL_LINFLEX9_PRIORITY;
  INTC.PSR[SPC5_LINFLEX9_TXI_NUMBER].R = SPC5_SERIAL_LINFLEX9_PRIORITY;
  INTC.PSR[SPC5_LINFLEX9_ERR_NUMBER].R = SPC5_SERIAL_LINFLEX9_PRIORITY;
#endif
}
